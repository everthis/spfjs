...
function $spf$net$xhr$send$$($addContentTypeFormUrlEncoded_method$$2$$, $url$$61$$, $data$$34$$, $isFormData_opt_options$$17$$) {
  var $options$$4$$ = $isFormData_opt_options$$17$$ || {}, $chunked$$ = !1, $offset$$14$$ = 0, $timer$$, $xhr$$ = new XMLHttpRequest;
  ...
  $options$$4$$.withCredentials && ($xhr$$.withCredentials = $options$$4$$.withCredentials);
  $isFormData_opt_options$$17$$ = "FormData" in window && $data$$34$$ instanceof FormData;
  $addContentTypeFormUrlEncoded_method$$2$$ = "POST" == $addContentTypeFormUrlEncoded_method$$2$$ && !$isFormData_opt_options$$17$$;
...
function $spf$nav$request$send$$($url$$62$$, $opt_options$$18$$) {
  ...
  $fn$$inline_123_options$$5$$.withCredentials && ($chunking_headerId_key$$51_state$$inline_199_uid$$inline_124_xhrOpts$$.withCredentials = $fn$$inline_123_options$$5$$.withCredentials);
...
function $spf$nav$load_$$($url$$86$$, $options$$21$$, $info$$10$$) {
  ...
  if ($spf$nav$dispatchRequest_$$($url$$86$$, void 0, void 0, $options$$21$$, !0)) {
    ...
    $info$$10$$.type = "load";
    $spf$nav$request$send$$($url$$86$$, {method:$options$$21$$.method, headers:$options$$21$$.headers, $onPart$:$handlePart$$1$$, $onError$:$handleError$$4$$, $onSuccess$:$handleSuccess$$1$$, $postData$:$options$$21$$.postData, type:$info$$10$$.type, withCredentials:$options$$21$$.withCredentials});
  }
}
